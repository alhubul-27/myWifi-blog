                                        ...
                                        <tbody class="fs-6">
                                            ...
                                            foreach ($datas as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" class="text-decoration-none btn btn-danger btn-sm m-1" data-toggle="modal" data-target="#deleteModal<?= $data['id_ulasan']; ?>">
                                                            <i class="bi bi-trash3"></i>
                                                        </a>
                                                    </td>

                                                    <div class="modal fade" id="deleteModal<?= $data['id_ulasan']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="function.php?id=<?= $data['id_ulasan']; ?>" method="post">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                                                                        <button type="submit" class="btn btn-danger" name="deleteUlasan">Hapus</button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
